    ...
    <div className="Skill_Content">
      ...
      <span className="Skill_Content">
        <div className="SKill_box">
          ...
          >
            <div className="Skill_label">Intermediate</div>
          </div>
          <div
            className="Skill_image_container"
      ...
      <span className="Skill_Content">
        ...
        >
          <div className="Skill_label">Basic</div>
        </div>
      </span>
      ...
      <span className="Skill_Content">
        <div
          className="Skill_image_container"
          style={{ backgroundImage: `url(${Window_logo})` }}
        >
          <div className="Skill_label">Expert</div>
        </div>
        <div
          className="Skill_image_container"
